  ...
  return (
    <main>
      <div className="legal container prose prose-sm lg:prose-xl md:prose-lg">
        ...
        <p>
          <strong>Effective Date:</strong> 07 August 2024
        </p>
        <p>Welcome to Hoople!</p>
        <p>
          ...
          our scavenger hunt game application {'("App")'}.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              information about your device and usage of the App, including your
              IP address, browser type, operating system, device information,
              and the pages you visit within the App.
            </p>
          </li>
          <li>
            <p>
              <strong>Location Data:</strong>&nbsp;With your consent, we may
              collect your precise location data to enhance your hunt
              experience.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <p>Provide, operate, and maintain the App.</p>
          </li>
          <li>
            <p>Improve, personalize, and expand the App`s features.</p>
          </li>
          <li>
            <p>Understand and analyze how you use the App.</p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              ...
              assist us in operating the App and providing services on our
              behalf, subject to confidentiality agreements.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          <strong>5. Your Data Protection Rights</strong>
        </p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ProvideThe right to access – You have the right to request copies
          ...
          <li>
            <p>
              The right to erasure – You have the right to request the deletion
          ...
          <li>
            <p>
              ...
              the restriction of processing your personal information under
              certain conditions.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              The right to data portability – You have the right to request the
